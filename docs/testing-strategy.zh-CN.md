...
2026-08-08 的按需候选再次显式运行了两个规模，并增加相互独立的活动页签门禁：10k 建图加孤立投影为 94.9 ms，6 次全孤立投影为 201.4 ms；6 次“无效链接”页签刷新仅 0.3 ms，且没有计算非活动的孤立投影。50k 对应数据为 537.0 ms、3 次孤立投影 501.3 ms，以及 3 次“无效链接”刷新 0.2 ms。孤立投影门禁采用 2,000 ms/8,000 ms，“无效链接”采用 500 ms/1,000 ms。这些合成证据约束了投影隔离，但不能替代正式 Vault 的启动、交互掉帧或最长主线程任务测量。
